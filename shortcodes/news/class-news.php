...
class Influen_News extends Influen_Shortcode
{

    protected $tag = 'roots_news';
    ...
    {
        return array(
            'name'        => esc_html__('News', 'influen'),
            'description' => esc_html__('News Section', 'influen'),
            'base'        => $this->get_tag(),
            ...
            'params'      => array(
                ...
                array(
                    ...
                    "value"         => influen_get_custom_terms_vc('category'),
