...
class Pagelink_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'pagelink_widget',
			esc_html__( 'MEDIM::Page Link', 'medim' )
		);
	}
	...
	private $widget_fields = array(
		...
		array(
			'label' => 'Page Five Name',
			'id' => 'pagefivename_text',
			'default' => 'home5',
			'type' => 'text',
		),
		array(
			'label' => 'Page Five Link',
			'id' => 'pagefivelink_text',
			'default' => '#',
			'type' => 'text',
		),
	);
	...
	public function widget( $args, $instance ) {
        ...
        <div class="footer-widget">
                <ul>
                            ...
                            <li>
								<a href="<?php echo $instance['pagefivelink_text'];?>">
									<i class="icofont-caret-right"></i>
                                    <?php echo $instance['pagefivename_text'];?>
                                </a>
                            </li>
...
function register_pagelink_widget() {
	register_widget( 'Pagelink_Widget' );
}
add_action( 'widgets_init', 'register_pagelink_widget' );